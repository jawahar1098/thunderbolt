...
#     try:
#         print(numbers)
#         missing_numbers = mongothunder.number_anaysis.distinct('source_number', {'source_numbers': {'$nin': numbers},'user':user})

#         # Insert missing numbers into the collection
#         for number in numbers:
#             if number not in missing_numbers:
#                 mongothunder.number_anaysis.insert_one({'source_number': number,'user':user})
#         # state_change_detection(user)
#         response = {'data_dict': '', 'status':'success', 'message':'numbers added successfully'}
...
# user = "a@gmail.com"
# numbers = ['6238893069','6238901436']
# add_intresred_numbers(user,numbers)
...
# def cdr_state_finding(numbers):
#     # numbers = numbers.split(",")
#     print(numbers,"newdaa numbers")
#     cdr_pipeline = [
...
#         # Initialize a counter to keep track of the number of unique states processed
#         state_counter = 0
...
# user = "a@gmail.com"
# numbers = ['9821610149','9354048282','6001337943'] 
# cdr_state_finding(numbers)
