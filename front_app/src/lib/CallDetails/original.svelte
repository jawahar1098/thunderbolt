      ...
      <table>
        <thead style="position: sticky;">
          <tr>
            ...
            <th style="width: 10%;">OTHER ADDRESS</th>
            <th style="width: 4.5%;">CALLDATE</th>
            <th style="width: 4%;">CALLTIME</th>
            <th style="width: 3%;">CALL TYPE</th>
            <th style="width: 3.5%;">DURATION</th>
            <th style="width: 6.8%;">IMEI</th>
            <!-- added -->
            <th style="width: 6.8%;">IMSI</th>

            <th style="width: 5%;">CELLID</th>
            <th style="width: 10%;">AREA DESCRIPTION</th>
