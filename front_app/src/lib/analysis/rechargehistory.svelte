<script>
  ...
  // contacts_of_mobileNumber MOBILE HANDSET SEARCH,,mobile_handset_analysis flask endpoint, completed
    ...
    active_inactive_period.append("number", number);
    active_inactive_period.append("mode", "recharge_history");
    showProgress = true;
    // try {
          ...
          <tr>
            ...
            >
              ...
              <br /><input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("dealer_address", event)}
              />
            </th>
            <th
              scope="col"
              ...
              <input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("dealer_contact", event)}
              />
            </th>
            <th
              scope="col"
              ...
              <br /><input
                class="input input-sm"
                placeholder="search"
                on:input={(event) => handleColumnSearch("dealername", event)}
              />
            </th>
            <th
              scope="col"
              ...
              <br /><input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("mode_of_recharge", event)}
              />
            </th>
            <th
              scope="col"
            ...
            <th
              ...
              <br /><input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("recharge_amount", event)}
              />
            </th>
            <th
              scope="col"
              ...
              <br /><input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("transaction_details", event)}
              />
            </th>
          </tr>
        </thead>
        <tbody>
          {#each filteredResults as tblD}
            <tr class="border-b hover:bg-gray-100 dark:border-neutral-500">
              ...
              <td
                class="border-r px-4 py-2 font-medium text-ellipsis dark:border-neutral-500"
                >{tblD["dealer_address"]}</td
              >
              <td
                class="border-r px-4 py-2 font-medium text-ellipsis dark:border-neutral-500"
                >{tblD["dealer_contact"]}</td
              >
              <td
                class="border-r px-4 py-2 font-medium text-ellipsis dark:border-neutral-500"
                >{tblD["dealername"]}</td
              ...
              <td
                class="border-r px-4 py-2 font-medium text-ellipsis dark:border-neutral-500"
                >{tblD["recharge_amount"]}</td
              >
              <td
                class="border-r px-4 py-2 font-medium text-ellipsis dark:border-neutral-500"
                >{tblD["transaction_details"]}</td
              >
            </tr>
          {/each}
        </tbody>
