<script>
  ...
  // contacts_of_mobileNumber MOBILE HANDSET SEARCH,,mobile_handset_analysis flask endpoint, completed
   function active_inactive_period_fuc() {
    ...
    active_inactive_period.append("mode", "sm_poa");
    showProgress = true;
    // try {
  ...
  function handleColumnSearch(column, event) {
    console.log(event.target.value, "Column Event");
    const filterValue = event.target.value.trim().toLowerCase();
    // console.log(filterValue, "data");
    columnFilters[column] = filterValue;
    console.log(columnFilters[column], "Column Filters");
    applyFilters();
  }
  ...
  function applyFilters() {
    const filteredData = final_result.filter((item) => {
      for (const field in columnFilters) {
        console.log(field, "column filed");
        const filterValue = columnFilters[field];
        console.log(filterValue, "data");
        if (filterValue !== "") {
          console.log(item[field], "dataass");
          ...
          <tr>
            ...
            <th
              ...
              <br /><input
                ...
                placeholder="search"
                on:input={(event) =>
                  handleColumnSearch("sim_activation_date", event)}
              />
            </th>
            <th
              scope="col"
