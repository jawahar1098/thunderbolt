<script>
  ...
  function IMSI_search() {
    gotResult = false;
    const IMSI_search = new FormData();
    IMSI_search.append("number", number);
    IMSI_search.append("mode", "IMSIPhone");
    ...
    //   });
      ...
      postRequest(fetch,url,IMSI_search)
      .then(data => {
        ...
        if (data["headers"] === "No Data") {
          ...
          gotResult = true;
          console.log(gotResult, "---inside data show");
          dispatch("updateData", filteredResults);
          HomeContentHeading = "imsiphonepage";
...
<div class="relatieve">
  {#if gotResult}
    <div class="justify-center mt-3">
      <h2 class="heading" style="margin-left: 2%;">Phone to IMSI Data</h2>
    </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="width: 3%;">INCOMING</th>
            <th style="width: 3%;">OUTGOING</th>
