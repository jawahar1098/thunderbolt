<script context="module">
  ...
  import Ingestion from "$lib/database/Ingestion.svelte";

  export const navOptions = [
    { page: "Dashboard", component: Ingestion },
    { page: "Automation", component: Automation },
    { page: "Manual", component: Directfiles },
  ];
</script>
